...
c.execute("DROP TABLE vocab_n2")
c.execute("CREATE TABLE vocab_n2(id integer primary key, kanji text UNIQUE NOT NULL, hiragana text NOT NULL, en text NOT NULL, vn text NOT NULL)")
conn.commit()
